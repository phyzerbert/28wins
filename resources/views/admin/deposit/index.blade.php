                ...
                <div class="card card-body card-fill">
                    <div class="clearfix">
                        ...
                        <div class="float-right">
                            <label for="" class="">Transfer : </label>                            
                            <input type="checkbox" class="" id="transfer_flag" @if($_setting->transfer_flag) checked @endif data-toggle="toggle">
                            <label for="" class="">Deposit : </label>
                            <input type="checkbox" class="" id="deposit_flag" @if($_setting->deposit_flag) checked @endif data-toggle="toggle">
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#transfer_flag").change(function() {
                let flag = 0;
                if($(this).is(":checked")){ flag = 1; }else{ flag = 0; }
                let self = $(this);
                $.ajax({
                    url: "{{route('admin.setting.transfer_flag')}}",
                    type: "POST",
                    dataType: "json",
                    data: {flag:flag},
                    success: function (data) {
