            ...
            <div class="col-md-12">
                <div class="card card-body card-fill">
                    <div class="clearfix">
                        ...
                        @if($agent)
                            <h6 class="float-left ml-4 mt-1"><a href="{{route('admin.user.index')}}?agent_id={{$agent->agent_id}}"><span class="badge badge-primary"><i class="fas fa-arrow-alt-circle-left mr-1"></i>{{__('words.back')}}</span></a></h6>
                        @endif
                        <form action="" class="form-inline float-right" method="post">
                            ...
                            @if($agent)
                                <a href="{{route('admin.report.total', $agent->id)}}" class="btn btn-sm btn-info float-right mt-2 mt-md-0 mr-md-2"><i class="fas fa-chart-bar mr-1"></i>{{__('words.total_report')}}</a>
                            @else
                                <a href="{{route('admin.report.total')}}" class="btn btn-sm btn-info float-right mt-2 mt-md-0 mr-md-2"><i class="fas fa-chart-bar mr-1"></i>{{__('words.total_report')}}</a>                            
                            @endif
                        ...
                        <table class="table table-bordered table-hover">
                            <thead class="thead-colored thead-primary">
                                <tr class="bg-blue">
                                    ...
                                    <th>{{__('words.last_login_time')}}</th>
                                    <th>{{__('words.description')}}</th>
                                    <th style="width:150px">{{__('words.action')}}</th>
                                </tr>
                            </thead>
                            <tbody>                                
                                @forelse ($data_agent as $item)
                                    <tr>
                                        ...
                                        <td class="last_login_at">{{$item->last_login_at}}</td>
                                        <td class="description">{{$item->description}}</td>
                                        <td class="py-1">
                                            <a href="javascript:;" class="btn btn-sm btn-primary btn-icon mr-1 btn-edit-agent" data-id="{{$item->id}}" data-toggle="tooltip" title="{{__('words.edit')}}"><i class="fa fa-edit"></i></a>
                                            <a href="{{route('admin.agent.delete', $item->id)}}" class="btn btn-sm btn-danger btn-icon mr-1 btn-confirm" data-toggle="tooltip" title="{{__('words.delete')}}"><i class="fas fa-trash-alt"></i></a>
                                            <a href="{{route('admin.set_score', ['agent', $item->id])}}" class="btn btn-sm btn-info btn-icon mr-1" data-toggle="tooltip" title="{{__('words.set_score')}}"><i class="fas fa-coins"></i></a>
                                            {{-- <a href="{{route('admin.report.agent', $item->id)}}" class="btn btn-sm btn-secondary btn-icon mr-1" data-toggle="tooltip" title="{{__('words.report')}}"><i class="fas fa-chart-pie"></i></a> --}}
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="15" align="center">{{__('words.no_data')}}</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>                
                                ...
                                @forelse ($data_user as $item)
                                    <tr>
                                        ...
                                        <td class="py-1">
                                            ...
                                            <a href="{{route('admin.user.delete', $item->id)}}" class="btn btn-sm btn-danger btn-icon mr-1 btn-confirm" data-toggle="tooltip" title="{{__('words.delete')}}"><i class="fas fa-trash-alt"></i></a>
                                            <a href="{{route('admin.set_score', ['user', $item->id])}}" class="btn btn-sm btn-info btn-icon mr-1" data-toggle="tooltip" title="{{__('words.set_score')}}"><i class="fas fa-coins"></i></a>
                                            {{-- <a href="{{route('admin.report.user', $item->id)}}" class="btn btn-sm btn-secondary btn-icon mr-1" data-toggle="tooltip" title="{{__('words.report')}}"><i class="fas fa-chart-pie"></i></a> --}}
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
            ...
            <div class="modal-content">
                ...
                <form action="" id="create_agent_form" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="control-label">{{__('words.commission_percentage')}}  <span class="text-danger">*</span></label>
                            <input type="number" name="rate" min="0" class="form-control rate" placeholder="{{__('words.commission_percentage')}}" required>
                        ...
                        <div class="form-group password-field">
                            ...
                            <input type="number" name="score" min="0" step="0.01" class="form-control score" placeholder="{{__('words.score')}}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" name="rate" min="0" class="form-control rate" placeholder="{{__('words.commission_percentage')}}" />
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control password" type="password" name="password" placeholder="{{__('words.password')}}" autocomplete="off" />
                            <span class="invalid-feedback password_error">
                                <strong></strong>
                            </span>
                        </div>    
                        <div class="form-group password-field">
                            <label class="control-label">{{__('words.confirm_password')}}</label>
                            <input type="password" name="password_confirmation" class="form-control confirm_password" placeholder="{{__('words.confirm_password')}}" required>
                        </div>
                        <div class="form-group">
                            <label class="control-label">{{__('words.description')}}</label>
