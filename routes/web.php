...
Route::group(['prefix' => 'admin','namespace' => 'Admin'],function ($router){
    ...
    $router->post('setting/transfer_flag', 'SettingController@transfer_flag')->name('admin.setting.transfer_flag');
    ...
    $router->get('url','SettingController@get_url')->name('admin.game.url');
    $router->post('url/create', 'SettingController@create_url')->name('admin.game_url.create');
    $router->post('url/update', 'SettingController@update_url')->name('admin.game_url.update');
    $router->get('url/delete/{id}', 'SettingController@delete_url')->name('admin.game_url.delete');
...
Route::group(['prefix' => 'agent','namespace' => 'Agent'],function ($router){
    ...
    $router->get('/', 'LoginController@showLoginForm')->name('agent.index');
...
Route::group(['prefix' => 'game', 'namespace' => 'Game'],function ($router){
    ...
    $router->get('goldenf_lottery', 'GameController@goldenf_lottery')->name('game.goldenf_lottery.index');
    $router->get('goldenf_lottery_list', 'GameController@goldenf_lottery_list')->name('game.goldenf_lottery.list');
    $router->get('goldenf_lottery_play', 'GameController@goldenf_lottery_play')->name('game.goldenf_lottery.play');
    $router->get('abs_play', 'GameController@abs_play')->name('game.abs.play');
});
